...
| 1. Land cover | [PASDA dataset 1587, Philadelphia Land Cover Raster 2018](https://imagery.pasda.psu.edu/arcgis/rest/services/pasda/PhillyLULC/MapServer/2) | Seven official classes made from 2018 LiDAR and 2017 NAIP imagery. The source is a classification aid, not current photography. | The 521,373,667 byte archive has SHA-256 `555ab81428c239dd4d1a1f162fdd072f4ff1b0b2ab15a2e96a3f241e2823bb3f`. A pinned OSGeo image converts `landcover_2018_philadelphia` to a 3 metre local mask. | Grade canopy, grass or shrub, and water while preserving the 2025 aerial pixels. City hydrology has priority. Keep source and derived tiles local until City and PASDA publication rights are confirmed. |
